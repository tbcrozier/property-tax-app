...
bq show public-data-dev:property_tax.fema_floodplain
Table public-data-dev:property_tax.fema_floodplain

   Last modified              Schema             Total Rows   Total Bytes   Expiration   Time Partitioning   Clustered Fields   Total Logical Bytes   Total Physical Bytes   Labels
 ----------------- ---------------------------- ------------ ------------- ------------ ------------------- ------------------ --------------------- ---------------------- --------
  06 Apr 20:56:38   |- DFIRM_ID: string          17784        3147497                                                           3147497               643418
                    |- Version_ID: string
                    |- FloodAreaID: string
                    |- StudyType: string
                    |- FloodZone: string
